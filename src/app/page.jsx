...
export default function Home() {
    ...
    return (
        <main className="overflow-y-hidden m-0 p-0 min-h-screen overflow-hidden">
            ...
            <section className="grid grid-cols-1 grid-rows-3 bg-no-repeat bg-contain bg-opaque-50 opaque-20" style={{
